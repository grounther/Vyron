...
export const products: Product[] = [
  {
    ...
    variants:[
      ...
      {name:'CP Camouflage',sku:'CJYD192968905EV',stock:10000,image:slingImages[12]},
      {name:'Desert Digital',sku:'CJYD192968904DW',stock:10000,image:slingImages[10]},
      {name:'Jungle Digital',sku:'CJYD192968903CX',stock:10000,image:slingImages[9]},
      {name:'Khaki',sku:'CJYD192968901AZ',stock:12000,image:slingImages[4]},
      {name:'Military Green',sku:'CJYD192968908HS',stock:12000,image:slingImages[2]},
      {name:'Sansha Camouflage',sku:'CJYD192968907GT',stock:10000,image:slingImages[0]},
    ],
