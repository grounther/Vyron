...
const links = [
  ['Shop','/shop'], ['Tactical','/category/tactical'], ['Automotive','/category/automotive'], ['Desk','/category/desk-setup'], ['Gaming','/category/gaming'], ['Smart Utility','/category/smart-utility']
]
    ...
    <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 md:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link href="/cart" className="relative inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-black text-zinc-950 shadow-[0_10px_40px_rgba(255,255,255,.12)] transition hover:-translate-y-0.5 hover:bg-zinc-100">
          <ShoppingBag size={17}/> <span className="hidden sm:inline">Cart</span>
