...
export default function ProductCard({p}:{p:Product}){
  ...
  return <Link href={`/product/${p.slug}`} className="card group relative block h-full overflow-hidden rounded-[1.35rem] transition duration-300 hover:-translate-y-1 hover:border-white/25 hover:shadow-[0_30px_100px_rgba(91,102,83,.16)] sm:rounded-[1.7rem]">
