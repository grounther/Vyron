...
export const metadata = {
  ...
  description: 'Scan of zoek TCG kaarten en bekijk de waarde vanuit de ASORTA prijsdatabase.',
}
...
export default function CardScannerPage() {
  return <main className="mx-auto max-w-7xl px-4 py-10 md:px-6">
    <section className="mb-8 overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top_right,rgba(183,200,173,.22),transparent_42%),linear-gradient(145deg,rgba(255,255,255,.08),rgba(255,255,255,.02))] p-6 md:p-10">
      ...
      <p className="mt-4 max-w-3xl text-white/60">Scan kaarttekst met je camera of zoek handmatig. De waardes komen uit je eigen ASORTA product- en pricingdatabase, dus er zijn geen externe API-tokens, daglimieten of scraping-blokkades nodig.</p>
    </section>
    <CardScannerClient />
  </main>
}
